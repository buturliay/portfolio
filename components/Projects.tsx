...
import CardGithubSkew from './CardGithubSkew';
    ...
    <section id="projects" className="relative bg-[#FCFCF1] py-15 px-[72px]">
      <div className="relative max-w-[1100px] mx-auto">
        ...
        <div className="flex flex-wrap pb-10 justify-center gap-[30px]">
          ...
          {/* Project 1 */}
          <CardGithubSkew className="w-[329px]">
            <div className="bg-white border border-[#03045E] shadow-md rounded-sm p-4 flex flex-col gap-[29px]">
